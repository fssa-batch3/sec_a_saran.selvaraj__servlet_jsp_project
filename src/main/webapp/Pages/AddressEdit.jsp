...
<title>Pet Mall || Address edit</title>
</head>
<body>
	...
	<form action="../AddressUpdateServlet" class="addresscreate">
		<div>
			<h1 class="h1">
				<label for="w3review" class="label">Update your address : </label>
			</h1>
			<textarea id="w3review" class="address" name="address" rows="7"
				cols="25" placeholder="Enter your address"></textarea>
